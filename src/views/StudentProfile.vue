<template>
  ...
  <div v-else>
    ...
    <div class="card" style="margin-top:12px">
      <div style="display:flex;align-items:center;gap:16px">
        ...
        <div>
          ...
          <div class="sub" style="color:var(--muted)">{{ student.className }}</div>
        </div>
        <span class="spacer" style="flex:1"></span>
        <span class="badge">作业提交 {{ Math.round(student.homework.rate * 100) }}%</span>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="suggestion" style="border-color:var(--accent);background:#eaf1fb">
